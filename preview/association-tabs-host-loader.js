(()=>{
  ...
  function inject(){
    ...
    const add=()=>{try{
      ...
      if(!doc.getElementById('associationOperationsV1Script')){const s=doc.createElement('script');s.id='associationOperationsV1Script';s.src='association-operations-v1.js?v=1';doc.body.appendChild(s);}
      if(!doc.getElementById('associationRoleReceiptsV1Script')){const s=doc.createElement('script');s.id='associationRoleReceiptsV1Script';s.src='association-role-receipts-v1.js?v=1';doc.body.appendChild(s);}
    }catch(e){}};
