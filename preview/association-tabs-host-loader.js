(()=>{
  ...
  function inject(){
    ...
    const add=()=>{try{const doc=frame.contentDocument;if(!doc||doc.getElementById('associationTabsV2Script'))return;const s=doc.createElement('script');s.id='associationTabsV2Script';s.src='association-tabs-v2.js?v=1';doc.body.appendChild(s);}catch(e){}};
