(()=>{
  ...
  function patchDetail(){
    ...
    lines[2]=`الدور ${turnTxt} • فترة الاستلام ${r.text} • ${r.nextText}`;
  ...
  function patchOverview(){
    ...
    if(hasAssociation){
      ...
      const desired=`مدة ${duration} شهر • الدفع كل ${payEvery} شهر • مدة كل دور استلام ${cycle} أشهر • يبدأ الدور التالي في اليوم التالي لانتهاء الدور السابق`;
